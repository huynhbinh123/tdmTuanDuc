                ...
                >
                  ...
                  >
                    <div class="flex justify-end items-center gap-4">
                      <span class="font-bold text-black">Tổng:</span>
      ...
      <UContainer>
        <div class="flex justify-between items-center container mx-auto">
          ...
          >
            ...
            <button class="py-2 px-4 font-bold">Danh mục sản phẩm</button>
            ...
            >
              <div>
                <div class="h-[472px] overflow-y-auto">
                  <ul class="w-[211px]">
                    <li

      ...
      <div class="bg-white">
        <div class="flex text-center justify-center">
          <h3 class="text-orange-500 text-3xl font-bold uppercase py-10">
            hệ thống showroom tmd tuấn đức
          </h3>
        </div>
          ...
          >
            <div class="flex">
              ...
              >
                ...
                <a :href="d.mapLink" class="text-xs">Bản đồ</a>
              </button>
            </div>
            <div>
                ...
                <li class="text-white text-sm">
                  <div class="flex flex-col">
                    <h3 class="text-gray-900">
                      <span class="text-black/90 font-bold">Địa chỉ:</span
                      >{{ d.address }}
                    </h3>

                    <h3 class="text-gray-900">
                      <span class="text-black/90 font-bold">Điện Thoại: </span
                      >{{ d.phone }}
                    </h3>

                    <h3 class="text-gray-900">
                      <span class="text-black/90 font-bold">Mở Cửa:</span
                      >{{ d.openTime }}
                    </h3>
                  </div>
                </li>

      ...
      <div class="">
        ...
        <div class="flex justify-between items-center mt-4">
          <div>
            <div class="flex items-center justify-center gap-2">
              <p class="text-gray-500">Giá khuyến mãi:</p>
              <span class="text-orange-600 lg:text-4xl text-2xl mr-2">
                {{ product.priceSale }}
              </span>
              <span class="text-gray-500 text-lg">(đã có VAT)</span>
            </div>
        ...
        <div class="flex items-center flex-wrap gap-4 mt-4 justify-between">
          ...
          <div class="flex items-center gap-2 lg:w-auto w-full">
            <p class="whitespace-nowrap text-gray-500">Số lượng</p>
            <input
              type="number"
              min="1"
              value="1"
    ...
    <div class="grid lg:grid-cols-2 grid-cols-1 gap-10 my-4">
      ...
      <div>
        <div class="border border-gray-200 rounded-lg shadow p-2 mb-6">
          <div class=" ">
            <div class="flex items-center gap-2 mb-3">
              <div class="w-4 h-6 bg-orange-500"></div>
              <h2 class="text-orange-500 font-bold text-xl px-2">Đặc tính</h2>
              <div class="flex-1 h-6 bg-gray-200"></div>
            </div>
          </div>
          <!-- Nội dung Đặc tính -->
        ...
        <div class="border border-gray-200 rounded-lg shadow p-2">
          <div class="flex items-center gap-2 mb-3">
            <div class="w-4 h-6 bg-orange-500"></div>
            <h2 class="text-orange-500 font-bold text-xl px-2">Đánh giá</h2>
            <div class="flex-1 h-6 bg-gray-200"></div>
          </div>
          <!-- Nội dung Đánh giá -->
          <div
          ...
          >
            ...
            <div class="text-black flex flex-col items-center">
              <p class="font-medium">
                Bạn muốn đánh giá hoặc thắc mắc về sản phẩm?!
              </p>
              <p class="text-black/80">Hãy click vào nút dưới đây!</p>
              ...
              >
                ...
                >
                  <p class="text-lg">Viết đánh giá / Bình luận sản phẩm</p>
                </UButton>
                  ...
                  <form class="space-y-4 p-4" @submit.prevent="submitReview">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        multiple
                        accept="image/*"
                        class="block w-full text-sm border border-gray-300 text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100 cursor-pointer"
                      />
                    </div>
